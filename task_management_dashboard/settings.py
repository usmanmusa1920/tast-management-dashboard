"""
Django settings for task_management_dashboard project.
...
SECRET_KEY = 'django-insecure-=r^7+79wfor+p4rk5*a_f!dr(va2e*z3%6q!6bytyg73ubz3v_'
...
ROOT_URLCONF = 'task_management_dashboard.urls'
...
WSGI_APPLICATION = 'task_management_dashboard.wsgi.application'
...
STATIC_URL = 'static/'
# STATIC_URL = 'static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # for production (server)
